...
class TransactionalResource:
    ...
    async def send(self, data: SendTransactionalEmailRequest):
        ...
        Args:
            data (SendTransactionalEmailModel): 
                A model containing all the information needed to send
        ...
        Note:
            ...
            - If using a template, the template_data should contain all variables
            ...
            - For high deliverability, ensure your sender domain is properly configured
              with SPF and DKIM
            - Tracking options (track_opens, track_clicks) require proper configuration
              of tracking domains
