...
class NewslettersResource:
    ...
    def create(self, data:CreateEmailNewsletterRequest):
        ...
        """
        return CreateNewsletterResponse.model_validate_json(json.dumps(self._client._request("POST", self.root_path, data=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)))
    ...
    def update(self, data: CreateEmailNewsletterRequest, newsletter_id: str):
        ...
        See Also:
            ...
            delete: For removing a newsletter
        """
        return UpdateNewsletterResponse.model_validate_json(json.dumps(self._client._request("PUT", self.root_path + "/" + newsletter_id, data=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)))
