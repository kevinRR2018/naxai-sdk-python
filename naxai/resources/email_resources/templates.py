...
class TemplatesResource:
    ...
    def update(self, template_id: str, data: CreateEmailTemplateRequest):
        ...
        """
        return UpdateTemplateResponse.model_validate_json(json.dumps(self._client._request("PUT", self.root_path + "/" + template_id, data=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)))
    ...
    def create(self, data: CreateEmailTemplateRequest):
        ...
        """
        return CreateTemplateResponse.model_validate_json(json.dumps(self._client._request("POST", self.root_path, data=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)))