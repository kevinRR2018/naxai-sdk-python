...
class BaseMessage(BaseModel):
    ...
    submitted_at: int = Field(alias="submittedAt", default=None)
    delivered_at: int = Field(alias="deliveredAt", default=None)
    received_at: Optional[int] = Field(alias="receivedAt", default=None)
    status: Literal["delivered", "failed"] = Field(default=None)
    status_code: int = Field(alias="statusCode", default=None)
    status_reason: str = Field(alias="statusReason", default=None)
    status_details: str = Field(alias="statusDetails", default=None)
    opt_out: bool = Field(alias="optOut", default=None)
