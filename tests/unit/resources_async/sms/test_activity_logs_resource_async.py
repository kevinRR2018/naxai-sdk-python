"""
Unit tests for the asynchronous ActivityLogsResource class for SMS.
"""
import json
import pytest
...
class TestActivityLogsResourceAsync:
    """Test suite for the asynchronous ActivityLogsResource class for SMS."""
    ...
    @pytest.mark.asyncio
    async def test_list_activity_logs_minimal_params(self, activity_logs_resource, mock_client):
    ...
    async def test_get_activity_log(self, activity_logs_resource, mock_client):
        ...
        result = await activity_logs_resource.get(message_id)
