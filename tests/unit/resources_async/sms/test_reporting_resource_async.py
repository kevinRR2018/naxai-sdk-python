"""
Unit tests for the asynchronous ReportingResource class for SMS.
"""
import json
import pytest
...
class TestReportingResourceAsync:
    """Test suite for the asynchronous ReportingResource class for SMS."""
    ...
    @pytest.mark.asyncio
    async def test_list_outgoing_metrics_day(self, reporting_resource, mock_client):
        ...
        # Call the method
        result = await reporting_resource.list_outgoing_metrics(
            group="day",
    ...
    @pytest.mark.asyncio
    async def test_list_outgoing_metrics_hour(self, reporting_resource, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_list_outgoing_metrics_invalid_date_format(self, reporting_resource, mock_client):
        ...
        try:
            await reporting_resource.list_outgoing_metrics_by_country(
    ...
    @pytest.mark.asyncio
    async def test_list_outgoing_metrics_missing_stop_date(self, reporting_resource):
        ...
        with pytest.raises(NaxaiValueError) as excinfo:
            await reporting_resource.list_outgoing_metrics(
                group="day",
                start_date="2023-01-01"
                # Missing stop_date
            )
    ...
    @pytest.mark.asyncio
    async def test_list_outgoing_metrics_by_country(self, reporting_resource, mock_client):
        ...
        # Call the method
        result = await reporting_resource.list_outgoing_metrics_by_country(
            start_date="2023-01-01",
            stop_date="2023-01-31"
        )
    ...
    @pytest.mark.asyncio
    async def test_list_incoming_metrics(self, reporting_resource, mock_client):
        ...
        # Call the method
        result = await reporting_resource.list_incoming_metrics(
            group="day",
            start_date="2023-01-01",
            stop_date="2023-01-31"
        )
    ...
    @pytest.mark.asyncio
    async def test_list_delivery_errors_metrics(self, reporting_resource, mock_client):
        ...
        # Call the method
        result = await reporting_resource.list_delivery_errors_metrics(
            start_date="2023-01-01",
            stop_date="2023-01-31"
        )
