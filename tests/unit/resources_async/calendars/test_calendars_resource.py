...
class TestCalendarsResource:
    """Test suite for the asynchronous CalendarsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_calendars(self, calendars_resource, mock_client, sample_schedule):
    ...
    @pytest.mark.asyncio
    async def test_get_calendar(self, calendars_resource, mock_client, sample_schedule):
    ...
    @pytest.mark.asyncio
    async def test_create_calendar(self, calendars_resource, mock_client, sample_schedule):
        ...
        # Call the method
        result = await calendars_resource.create(request_data)
    ...
    @pytest.mark.asyncio
    async def test_update_calendar(self, calendars_resource, mock_client, sample_schedule):
    ...
    @pytest.mark.asyncio
    async def test_delete_calendar(self, calendars_resource, mock_client):
        ...
        # Call the method
        calendar_id = "cal_123"
        result = await calendars_resource.delete(calendar_id)
    ...
    @pytest.mark.asyncio
    async def test_check_calendar(self, calendars_resource, mock_client):
        ...
        result = await calendars_resource.check(calendar_id, timestamp)
    ...
    @pytest.mark.asyncio
    async def test_check_calendar_not_available(self, calendars_resource, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_add_exclusions(self, calendars_resource, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_add_exclusions_too_many(self, calendars_resource):
        ...
        with pytest.raises(NaxaiValueError) as excinfo:
            await calendars_resource.add_exclusions("cal_123", exclusions)
        
        assert "You can only add up to 1000 exclusions at a time" in str(excinfo.value)

    @pytest.mark.asyncio
    async def test_delete_exclusions(self, calendars_resource, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_delete_exclusions_too_many(self, calendars_resource):
        ...
        # Call the method and expect an exception
        with pytest.raises(NaxaiValueError) as excinfo:
            await calendars_resource.delete_exclusions("cal_123", exclusions)
