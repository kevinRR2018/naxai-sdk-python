"""
Unit tests for the asynchronous RecipientsResource class.
"""
import json
import pytest
...
class TestRecipientsResource:
    """Test suite for the asynchronous RecipientsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_recipients(self, recipients_resource, mock_client):
        ...
        result = await recipients_resource.list(broadcast_id, page=1, page_size=25, status="delivered")
    ...
    @pytest.mark.asyncio
    async def test_get_recipient(self, recipients_resource, mock_client):
        ...
        result = await recipients_resource.get(broadcast_id, recipient_id)
