"""
Unit tests for the asynchronous ReportingResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.email_resources.reporting import ReportingResource
...
class TestReportingResource:
    """Test suite for the asynchronous ReportingResource class."""
