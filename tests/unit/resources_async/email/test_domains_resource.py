"""
Unit tests for the asynchronous DomainsResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.email_resources.domains import DomainsResource
...
class TestDomainsResource:
    """Test suite for the asynchronous DomainsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_domains(self, domains_resource, mock_client):
        ...
        # Call the method
        result = await domains_resource.list()
    ...
    @pytest.mark.asyncio
    async def test_get_domain(self, domains_resource, mock_client):
        ...
        result = await domains_resource.get(domain_id)
    ...
    @pytest.mark.asyncio
    async def test_create_domain(self, domains_resource, mock_client):
        ...
        result = await domains_resource.create(domain_name, shared_with_subaccounts)
    ...
    @pytest.mark.asyncio
    async def test_update_domain(self, domains_resource, mock_client):
        ...
        # Call the method
        domain_id = "dom_123abc"
        result = await domains_resource.update(domain_id)
    ...
    @pytest.mark.asyncio
    async def test_delete_domain(self, domains_resource, mock_client):
        ...
        # Call the method
        domain_id = "dom_123abc"
        result = await domains_resource.delete(domain_id)
    ...
    @pytest.mark.asyncio
    async def test_verify_domain(self, domains_resource, mock_client):
        ...
        # Call the method
        domain_id = "dom_123abc"
        result = await domains_resource.verify(domain_id)
    ...
    @pytest.mark.asyncio
    async def test_update_tracking_settings(self, domains_resource, mock_client):
        ...
        domain_id = "dom_123abc"
        enabled = True
        result = await domains_resource.update_tracking_settings(domain_id, enabled)
    ...
    @pytest.mark.asyncio
    async def test_update_tracking_cname(self, domains_resource, mock_client):
        ...
        domain_id = "dom_123abc"
        prefix = "custom-track"
        result = await domains_resource.update_tracking_cname(domain_id, prefix)
