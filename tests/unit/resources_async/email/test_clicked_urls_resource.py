"""
Unit tests for the asynchronous ClickedUrlsResource class.
"""
import json
import datetime
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.email_resources.reporting_resources.clicked_urls import ClickedUrlsResource
...
class TestClickedUrlsResource:
    """Test suite for the asynchronous ClickedUrlsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_clicked_urls_default_params(self, clicked_urls_resource, mock_client):
        ...
        result = await clicked_urls_resource.list()
    ...
    @pytest.mark.asyncio
    async def test_list_clicked_urls_custom_params(self, clicked_urls_resource, mock_client):
        ...
        group = "month"
        result = await clicked_urls_resource.list(start=start, stop=stop, group=group)
