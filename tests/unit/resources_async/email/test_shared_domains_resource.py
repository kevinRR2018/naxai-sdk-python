"""
Unit tests for the asynchronous SharedDomainsResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.email_resources.domains_resources.shared_domains import SharedDomainsResource
...
class TestSharedDomainsResource:
    """Test suite for the asynchronous SharedDomainsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_shared_domains(self, shared_domains_resource, mock_client):
        ...
        # Call the method
        result = await shared_domains_resource.list()
