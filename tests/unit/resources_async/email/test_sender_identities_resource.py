"""
Unit tests for the asynchronous SenderIdentitiesResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.email_resources.sender_identities import SenderIdentitiesResource
...
class TestSenderIdentitiesResource:
    """Test suite for the asynchronous SenderIdentitiesResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_senders(self, sender_identities_resource, mock_client):
        ...
        # Call the method
        result = await sender_identities_resource.list()
    ...
    @pytest.mark.asyncio
    async def test_list_senders_with_filters(self, sender_identities_resource, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_get_sender(self, sender_identities_resource, mock_client):
        ...
        result = await sender_identities_resource.get(sender_id)
    ...
    @pytest.mark.asyncio
    async def test_create_sender(self, sender_identities_resource, mock_client):
        ...
        email = "new-sender@example.com"
        name = "New Sender"
        result = await sender_identities_resource.create(domain_id, email, name)
    ...
    @pytest.mark.asyncio
    async def test_update_sender(self, sender_identities_resource, mock_client):
        ...
        name = "Updated Sender"
        email = "updated-sender@example.com"
        result = await sender_identities_resource.update(sender_id, name, email)
    ...
    @pytest.mark.asyncio
    async def test_delete_sender(self, sender_identities_resource, mock_client):
        ...
        # Call the method
        sender_id = "snd_123abc"
        result = await sender_identities_resource.delete(sender_id)
