...
class TestContactsResourceAsync:
    ...
    @pytest.mark.asyncio
    async def test_search_without_condition(self, contacts_resource, mock_client):
        ...
        # Call the method
        result = await contacts_resource.search(page=1, page_size=50, sort="createdAt:desc")
