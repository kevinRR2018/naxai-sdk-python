"""
Unit tests for the asynchronous ExportsResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock, AsyncMock
from naxai.resources_async.people_resources.exports import ExportsResource
...
class TestExportsResourceAsync:
    """Test suite for the asynchronous ExportsResource class."""
    ...
    @pytest.mark.asyncio
    async def test_list_exports(self, exports_resource, mock_client):
        ...
        # Call the method
        result = await exports_resource.list()
    ...
    @pytest.mark.asyncio
    async def test_create_export(self, exports_resource, mock_client):
        ...
        # Call the method
        result = await exports_resource.create(condition)
    ...
    @pytest.mark.asyncio
    async def test_get_export(self, exports_resource, mock_client):
        ...
        result = await exports_resource.get(export_id)
    ...
    @pytest.mark.asyncio
    async def test_get_download_url(self, exports_resource, mock_client):
        ...
        # Call the method
        export_id = "exp_123abc"
        result = await exports_resource.get_download_url(export_id)
