"""
Unit tests for the synchronous TemplatesResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock
from naxai.resources.email_resources.templates import TemplatesResource
...
class TestTemplatesResource:
    """Test suite for the synchronous TemplatesResource class."""
    ...
    def test_list_templates(self, templates_resource, mock_client):
        ...
        # Call the method
        result = templates_resource.list(page=1, page_size=25)
    ...
    def test_get_template(self, templates_resource, mock_client):
        ...
        result = templates_resource.get(template_id)
    ...
    def test_create_template_html(self, templates_resource, mock_client):
        ...
        # Call the method
        result = templates_resource.create(request_data)
    ...
    def test_create_template_editor(self, templates_resource, mock_client):
    ...
    def test_update_template(self, templates_resource, mock_client):
        ...
        # Call the method
        template_id = "tpl_123abc"
        result = templates_resource.update(template_id, request_data)
    ...
    def test_delete_template(self, templates_resource, mock_client):
        ...
        # Call the method
        template_id = "tpl_123abc"
        result = templates_resource.delete(template_id)
    ...
    def test_list_shared_templates(self, templates_resource, mock_client):
        ...
        # Call the method
        result = templates_resource.list_shared(page=1, page_size=25)
    ...
    def test_get_shared_template(self, templates_resource, mock_client):
        ...
        result = templates_resource.get_shared(template_id)
