"""
Unit tests for the synchronous TransactionalResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock
from naxai.resources.email_resources.transactional import TransactionalResource
...
class TestTransactionalResource:
    """Test suite for the synchronous TransactionalResource class."""
    ...
    def test_send_email(self, transactional_resource, mock_client):
        ...
        # Call the method
        result = transactional_resource.send(request_data)
    ...
    def test_send_email_with_attachments(self, transactional_resource, mock_client):
