"""
Unit tests for the synchronous EmailResource class.
"""
import json
import pytest
...
class TestEmailResource:
    """Test suite for the synchronous EmailResource class."""
    ...
    def test_send_email_basic(self, email_resource, mock_client):
    ...
    def test_send_email_with_all_options(self, email_resource, mock_client):
        ...
        cc_recipient = CCObject(email="cc@example.com", name="CC Recipient")
        bcc_recipient = BCCObject(email="bcc@example.com", name="BCC Recipient")
