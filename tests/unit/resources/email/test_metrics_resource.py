...
class TestMetricsResource:
    ...
    def test_list_metrics_default_params(self, metrics_resource, mock_client):
    ...
    def test_list_metrics_custom_params(self, metrics_resource, mock_client):
        ...
        group = "month"
        result = metrics_resource.list(start=start, stop=stop, group=group)
