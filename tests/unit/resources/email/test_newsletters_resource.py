"""
Unit tests for the synchronous NewslettersResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock
from naxai.resources.email_resources.newsletters import NewslettersResource
...
class TestNewslettersResource:
    """Test suite for the synchronous NewslettersResource class."""
    ...
    def test_list_newsletters(self, newsletters_resource, mock_client):
        ...
        # Call the method
        result = newsletters_resource.list(page=1, page_size=25)
    ...
    def test_get_newsletter(self, newsletters_resource, mock_client):
        ...
        result = newsletters_resource.get(newsletter_id)
    ...
    def test_create_newsletter_html(self, newsletters_resource, mock_client):
        ...
        # Call the method
        result = newsletters_resource.create(request_data)
    ...
    def test_create_newsletter_scheduled(self, newsletters_resource, mock_client):
    ...
    def test_update_newsletter(self, newsletters_resource, mock_client):
        ...
        # Call the method
        newsletter_id = "nws_123abc"
        result = newsletters_resource.update(request_data, newsletter_id)
    ...
    def test_delete_newsletter(self, newsletters_resource, mock_client):
        ...
        # Call the method
        newsletter_id = "nws_123abc"
        result = newsletters_resource.delete(newsletter_id)
