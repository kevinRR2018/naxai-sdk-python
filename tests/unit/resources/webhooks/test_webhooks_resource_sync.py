"""
Unit tests for the synchronous WebhooksResource class.
"""
import json
import pytest
...
class TestWebhooksResourceSync:
    """Test suite for the synchronous WebhooksResource class."""
    ...
    def test_list(self, webhooks_resource, mock_client):
    ...
    def test_create(self, webhooks_resource, mock_client):
        ...
        # Call the method
        result = webhooks_resource.create(
            name="Test Webhook",
            url="https://example.com/webhook",
    ...
    def test_get(self, webhooks_resource, mock_client):
        ...
        # Call the method
        result = webhooks_resource.get("wh_123")
    ...
    def test_delete(self, webhooks_resource, mock_client):
        """Test deleting a webhook."""
        # Setup mock response
        mock_client._request.return_value = None

        # Call the method
        result = webhooks_resource.delete("wh_123")
    ...
    def test_update(self, webhooks_resource, mock_client):
        ...
        # Call the method
        result = webhooks_resource.update("wh_123", update_ops)
    ...
    def test_list_last_events(self, webhooks_resource, mock_client):
        ...
        # Call the method
        result = webhooks_resource.list_last_events("wh_123")
    ...
    def test_list_events(self, webhooks_resource, mock_client):
        ...
        # Call the method
        result = webhooks_resource.list_events()
