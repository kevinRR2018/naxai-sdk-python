"""
Unit tests for the synchronous ActivityLogsResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock
from naxai.resources.voice_resources.activity_logs import ActivityLogsResource
...
class TestActivityLogsResource:
    """Test suite for the synchronous ActivityLogsResource class."""
    ...
    def test_list_activity_logs_with_all_filters(self, activity_logs_resource, mock_client):
    ...
    def test_get_activity_log(self, activity_logs_resource, mock_client):
        ...
        # Call the method
        call_id = "call_123"
        result = activity_logs_resource.get(call_id)
