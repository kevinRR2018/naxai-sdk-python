"""
Unit tests for the synchronous BroadcastsResource class.
"""
import json
import pytest
from unittest.mock import patch, MagicMock
from naxai.resources.voice_resources.broadcast import BroadcastsResource
...
class TestBroadcastsResource:
    """Test suite for the synchronous BroadcastsResource class."""
    ...
    def test_list_broadcasts(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        result = broadcasts_resource.list(page=1, page_size=25)
    ...
    def test_create_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        result = broadcasts_resource.create(request_data)
    ...
    def test_get_broadcast(self, broadcasts_resource, mock_client):
        ...
        result = broadcasts_resource.get(broadcast_id)
    ...
    def test_delete_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.delete(broadcast_id)
    ...
    def test_update_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.update(broadcast_id, request_data)
    ...
    def test_start_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.start(broadcast_id)
    ...
    def test_pause_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.pause(broadcast_id)
    ...
    def test_resume_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.resume(broadcast_id)
    ...
    def test_cancel_broadcast(self, broadcasts_resource, mock_client):
        ...
        # Call the method
        broadcast_id = "broadcast_123"
        result = broadcasts_resource.cancel(broadcast_id)
