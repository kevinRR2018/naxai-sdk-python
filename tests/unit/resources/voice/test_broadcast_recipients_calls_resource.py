"""
Unit tests for the synchronous CallsResource class.
"""
import json
import pytest
from unittest.mock import MagicMock
from naxai.resources.voice_resources.broadcast_resources.recipients_resources.calls import CallsResource
from naxai.models.voice.responses.broadcasts_responses import GetBroadcastRecipientCallsResponse


class TestCallsResource:
    """Test suite for the synchronous CallsResource class."""
    ...
    def test_list_calls(self, calls_resource, mock_client):
        ...
        result = calls_resource.list(broadcast_id, recipient_id)
