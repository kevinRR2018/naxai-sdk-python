"""
Unit tests for the synchronous InputResource class.
"""
import json
import pytest
from unittest.mock import MagicMock
from naxai.resources.voice_resources.broadcast_resources.broadcast_metrics_resources.input import InputResource
from naxai.models.voice.responses.broadcasts_responses import GetBroadcastInputMetricsResponse


class TestInputResource:
    """Test suite for the synchronous InputResource class."""
    ...
    def test_get_input_metrics(self, input_resource, mock_client):
        ...
        result = input_resource.get(broadcast_id)
