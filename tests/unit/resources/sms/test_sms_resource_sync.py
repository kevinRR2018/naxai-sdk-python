"""
Unit tests for the synchronous SMSResource class.
"""
import json
import pytest
...
class TestSMSResourceSync:
    """Test suite for the synchronous SMSResource class."""
    ...
    def test_send_with_from(self, sms_resource, mock_client):
    ...
    def test_send_with_sender_service_id(self, sms_resource, mock_client):
    ...
    def test_send_with_scheduled_at(self, sms_resource, mock_client):
    ...
    def test_send_missing_from_and_sender_service_id(self, sms_resource):
