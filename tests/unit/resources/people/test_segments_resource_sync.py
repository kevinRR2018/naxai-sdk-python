"""
Unit tests for the synchronous SegmentsResource class.
"""
import json
import pytest
...
class TestSegmentsResourceSync:
    """Test suite for the synchronous SegmentsResource class."""
    ...
    def test_list_segments(self, segments_resource, mock_client):
        ...
        # Call the method
        result = segments_resource.list(type_="dynamic", exclude_predefined=True)
    ...
    def test_get_segment(self, segments_resource, mock_client):
        ...
        result = segments_resource.get(segment_id)
    ...
    def test_create_segment(self, segments_resource, mock_client):
        ...
        # Call the method
        result = segments_resource.create(request_data)
    ...
    def test_update_segment(self, segments_resource, mock_client):
        ...
        # Call the method
        segment_id = "seg_123abc"
        result = segments_resource.update(segment_id, request_data)
    ...
    def test_delete_segment(self, segments_resource, mock_client):
        ...
        # Call the method
        segment_id = "seg_123abc"
        result = segments_resource.delete(segment_id)
    ...
    def test_history(self, segments_resource, mock_client):
        ...
        start = 1703066400000
        stop = 1703152800000
        result = segments_resource.history(segment_id, start, stop)
    ...
    def test_usage(self, segments_resource, mock_client):
        ...
        # Call the method
        segment_id = "seg_123abc"
        result = segments_resource.usage(segment_id)
