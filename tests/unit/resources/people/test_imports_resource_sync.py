"""
Unit tests for the synchronous ImportsResource class.
"""
import json
import pytest
...
class TestImportsResourceSync:
    """Test suite for the synchronous ImportsResource class."""
    ...
    def test_list_imports(self, imports_resource, mock_client):
    ...
    def test_get_import(self, imports_resource, mock_client):
        ...
        result = imports_resource.get(import_id)
