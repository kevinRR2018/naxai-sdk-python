"""
Unit tests for the synchronous NaxaiClient class.
"""
import json
import os
import time
...
class TestNaxaiClient:
    """Test suite for the NaxaiClient class."""
    ...
    def test_initialization_with_params(self, client_params, mock_httpx_client):
        ...
        client = NaxaiClient(**client_params)
    ...
    def test_initialization_missing_api_base_url(self, mock_httpx_client):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch('naxai.client.API_BASE_URL', None):
                with pytest.raises(NaxaiValueError) as excinfo:
                    NaxaiClient(
                        api_client_id="test_id",
                        api_client_secret="test_secret",
    ...
    def test_authentication_success(self, client_params, mock_httpx_client, mock_auth_response):
    ...
    def test_authentication_failure(self, client_params, mock_httpx_client):
    ...
    def test_token_reuse(self, client_params, mock_httpx_client, mock_auth_response):
        """Test token reuse when not expired."""
        mock_httpx_client.post.return_value = mock_auth_response
        
        client = NaxaiClient(**client_params)
        client._authenticate()  # First authentication
        ...
        client._authenticate()  # Should reuse token
        
        # Verify no new authentication request was made
        mock_httpx_client.post.assert_not_called()

    def test_token_refresh(self, client_params, mock_httpx_client, mock_auth_response):
        ...
        client._authenticate()  # Should refresh token
        
        # Verify a new authentication request was made
        mock_httpx_client.post.assert_called_once()

    def test_request_success(self, client_params, mock_httpx_client, mock_auth_response, mock_response):
    ...
    def test_request_with_params(self, client_params, mock_httpx_client, mock_auth_response, mock_response):
        """Test request with query parameters."""
        mock_httpx_client.post.return_value = mock_auth_response
        mock_httpx_client.request.return_value = mock_response
        
        client = NaxaiClient(**client_params)
        client._request("GET", "/test/path", params={"param1": "value1", "param2": "value2"})
    ...
    def test_request_with_json(self, client_params, mock_httpx_client, mock_auth_response, mock_response):
        """Test request with JSON body."""
        mock_httpx_client.post.return_value = mock_auth_response
        mock_httpx_client.request.return_value = mock_response
        
        client = NaxaiClient(**client_params)
        client._request("POST", "/test/path", json={"data": "value"})
    ...
    def test_request_with_custom_headers(self, client_params, mock_httpx_client, mock_auth_response, mock_response):
        """Test request with custom headers."""
        mock_httpx_client.post.return_value = mock_auth_response
        mock_httpx_client.request.return_value = mock_response
        
        client = NaxaiClient(**client_params)
        client._request("GET", "/test/path", headers={"Custom-Header": "value"})
    ...
    def test_handle_error_401(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_403(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_404(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_422(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_429(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_500(self, client_params, mock_httpx_client):
    ...
    def test_handle_error_invalid_json(self, client_params, mock_httpx_client):
    ...
    def test_close(self, client_params, mock_httpx_client):
